    ...
    <div>
      ...
      <Formik
        ...
        onSubmit={(values, { setSubmitting }) => {
          setTimeout(() => {
            ...
            axios.post('/api/lectureHomework/post', dataToSubmit).then(response => {
      ...
      >
        {props => {
          ...
          return (
            <Modal title="Post lecture homework" visible={IsPostVisible} onOk={handleSubmit} onCancel={postCancle}
