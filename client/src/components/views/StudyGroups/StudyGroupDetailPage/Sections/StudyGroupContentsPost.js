    ...
    <div>
      ...
      <Formik
        ...
        onSubmit={(values, { setSubmitting }) => {
          setTimeout(() => {
            ...
            axios.post('/api/studygroupContents/post', dataToSubmit).then(response => {
      ...
      >
        {props => {
          ...
          return (
            <Modal title="Post Study Group content" visible={IsPostVisible} onOk={handleSubmit} onCancel={postCancle}
