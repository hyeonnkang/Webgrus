        ...
        <div style={{ display: 'grid', gridTemplateColumns: '5fr 1fr 1fr'}}>
          ...
          <Formik
            ...
            onSubmit={(values, { setSubmitting }) => {
              setTimeout(() => {
                ...
                axios.post('/api/studygroupContents/edit', dataToSubmit).then(response => {
                  if (response.data.success) {
          ...
          >
            {props => {
              ...
              return (
                <Modal title="Edit StudyGroup content" visible={IsEditVisible} onOk={handleSubmit} onCancel={editCancle}
